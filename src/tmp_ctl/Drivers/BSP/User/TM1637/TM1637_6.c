...
void TM1637_DisplayChar_6(unsigned char ch,unsigned char p)
{
	...
	TM1637_Start_6();
	TM1637_WriteByte_6(0x44);//0x44固定模式有利于控制显示位，0x40则采用显示地址自加模式这里不使用
	TM1637_Ack_6();
	TM1637_Stop_6();
	TM1637_Start_6();
	
	TM1637_WriteByte_6(0xC0+p);//0X00地址开始显示
	TM1637_Ack_6();
		
	TM1637_WriteByte_6(NumDis[ch]);//显示
	TM1637_Ack_6();
...
void TM1637_Display_6(void)
{
	...
	TM1637_Start_6();
	TM1637_WriteByte_6(0x40);//0x40则采用显示地址自加1模式
	TM1637_Ack_6();
	TM1637_Stop_6();
	TM1637_Start_6();
	TM1637_WriteByte_6(0xC0);//0X00地址开始显示
	TM1637_Ack_6();
		
	TM1637_WriteByte_6(TIME[a]);//显示1
	TM1637_Ack_6();
	 if(x==1)
	{
		temp=TIME[b];
  ...
  temp^=0x80;  //10000000^11001111=01001111;01001111^10000000=11001111
	TM1637_WriteByte_6(temp);//显示2和跳动的冒号
	TM1637_Ack_6();
	
	TM1637_WriteByte_6(TIME[c]);//显示1
	TM1637_Ack_6();
		
	TM1637_WriteByte_6(TIME[d]);//显示4
	TM1637_Ack_6();
